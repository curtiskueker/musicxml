...
public class NotationsHandler implements ScoreElementHandler {
    private List<Notations> notationsList;

    public NotationsHandler(List<Notations> notationsList) {
        ...
        for(Element notationsSubelement : notationsSubelements) {
            ...
            switch (notationsSubelement.getTagName()) {
                ...
                case "slide":
                    ...
                    break;
                case "ornaments":
                    handler = new OrnamentHandler();
                    break;
                case "technical":
                    handler = new TechnicalHandler();
                    break;
                case "articulations":
                    handler = new ArticulationHandler();
                    break;
                case "dynamics":
            ...
            if (handler != null) notation = handler.handle(notationsSubelement);
            if (notation != null) {
